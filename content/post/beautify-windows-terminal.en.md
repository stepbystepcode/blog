...
[Click to download the new version of Powershell (PowerShell-x.x.x-win-x64.msi)](https://hub.fgit.cf/PowerShell/PowerShell/releases/latest)

[Click to download Git(Git-x.xx.x-64-bit.exe)](https://hub.fgit.cf/git-for-windows/git/releases/latest)

[Click to download oh-my-posh(install-amd64.exe)](https://hub.fgit.cf/JanDeDobbeleer/oh-my-posh/releases/latest)

[Click to download Checksum](https://ybygjylj.lanzouf.com/iYuZD06mepjc)
# 2. Install Git
# 3. Install Nerd Font
*Recommends JetBrainsMono*
[Click to download](https://hub.fgit.cf/ryanoasis/nerd-fonts/releases/download/v2.1.0/JetBrainsMono.zip)
