...
# 一、下载文件并校验文件完整性
[点击下载新版Powershell(PowerShell-x.x.x-win-x64.msi)](https://hub.fgit.cf/PowerShell/PowerShell/releases/latest)

[点击下载Git(Git-x.xx.x-64-bit.exe)](https://hub.fgit.cf/git-for-windows/git/releases/latest)

[点击下载oh-my-posh(install-amd64.exe)](https://hub.fgit.cf/JanDeDobbeleer/oh-my-posh/releases/latest)

[点击下载Checksum](https://ybygjylj.lanzouf.com/iYuZD06mepjc)
# 二、安装Git
# 三、安装Nerd Font字体
*推荐JetBrainsMono*
[点击下载](https://hub.fgit.cf/ryanoasis/nerd-fonts/releases/download/v2.1.0/JetBrainsMono.zip)
