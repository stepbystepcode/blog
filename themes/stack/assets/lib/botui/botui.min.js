...
!(function (t, e) {
	...
	return function (e, n) {
		...
		function i(t) {
			return t
				.replace(b.image, "<img class='botui-message-content-image' src='$2' alt='$1' />")
				.replace(b.icon, "<i class='botui-icon botui-message-content-icon fa fa-$1'></i>")
				.replace(b.link, o);
		}
		function a(t, e) {
				...
				handle_action_button: function (t) {
					for (var e = 0; e < this.action.button.buttons.length; e++)
						if (
							...
							if (
								(this.action.button.buttons[e].event(t), this.action.button.buttons[e].actionStop)
							)
								return !1;
							break;
						}
		...
		return (
			...
			(m.action = {
				...
				button: function (t) {
					return l(t), (t.type = "button"), (x.action.button.buttons = t.action), h(t);
				},
				select: function (t) {
					if (
						(l(t),
						...
						(t.action.searchselect =
							void 0 !== t.action.searchselect ? t.action.searchselect : p.searchselect),
					...
					return (
						t.action.searchselect ||
							t.action.options.unshift({ value: "", text: t.action.placeholder }),
